...
// ------------------------------
public final class ReferralSettingEvent extends Event {
    private final ImmutableRecord old;
    private final ImmutableRecord current;

    public ReferralSettingEvent(@NotNull final ImmutableRecord old, @NotNull final ImmutableRecord current) {
        this.old = old;
